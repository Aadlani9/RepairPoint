 ...
 *
 * INSTRUCCIONES:
 * 1. نسخ هذا الملف إلى السيرفر في مجلد config/
 * 2. تعديل بيانات الاتصال أدناه
 * 3. إعادة تسمية الملف إلى database.php على السيرفر
 */
...
// معلومات قاعدة البيانات الخاصة بالسيرفر
$config['database'] = [
    'host' => 'localhost',              // عنوان خادم MySQL (عادة localhost)
    'username' => 'u948397987_repair',  // اسم المستخدم لقاعدة البيانات
    'password' => 'YOUR_DB_PASSWORD',   // كلمة المرور (غيرها!)
    'database' => 'u948397987_repairpoint', // اسم قاعدة البيانات
    'charset' => 'utf8mb4',
    'port' => 3306
];
